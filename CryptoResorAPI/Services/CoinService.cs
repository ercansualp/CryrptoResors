...
namespace CryrptoResorAPI.Services
{
    ...
    public class CoinService : ICoinService
    {
        ...
        public CoinService(IHubContext<NotificationHub> notificationHub, ITelegramService telegramService)
        {
            ...
            _socket.OnMessage += async (sender, e) =>
            {
                ...
                if (openMinute != currentMinute)
                {
                    ...
                    if (percentage >= percentageIncrease || percentage <= -percentageDecrease)
                    {
                        ...
                        await _telegramService.SendMessageToGroupAsync($"{jsonData["s"]} strong warning!");
